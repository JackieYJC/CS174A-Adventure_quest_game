...
inherit(tetrahedron, shape);
	tetrahedron.prototype.populate = function()
	{
		...
		this.normals.push(vec3(0,1,0), vec3(1,0,0), vec3(0,0,1), vec3(a,a,a));
		this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0), vec2(1,1));
		this.indices.push(0,1,2, 0,1,3  ,0,2,3  ,1,2,3);
	};

	function tetrahedronA()
	{
		shape.call(this);
		this.populate();
		this.init_buffers();
	}
	inherit(tetrahedronA, shape);
		tetrahedronA.prototype.populate = function()
		{
			var a = 1/Math.sqrt(3);
			...
			this.vertices.push(vec3(0,1,0), vec3(1,0,0), vec3(0,0,1));
		...
		inherit(flake, shape);
			flake.prototype.populate = function()
			{
				var a = 1/Math.sqrt(2);
				...
				this.vertices.push(vec3(0,1,1), vec3(0,1,0), vec3(0,0,1));
				this.normals.push(vec3(1,0,0), vec3(1,0,0), vec3(1,0,0) );
				this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
				this.indices.push(9,10,11);

				this.vertices.push(vec3(0,1,1), vec3(1,0,1), vec3(0,0,1));
				this.normals.push(vec3(0,0,1), vec3(0,0,1), vec3(0,0,1) );
				this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
				this.indices.push(12,13,14);

				this.vertices.push(vec3(0,0,1), vec3(1,0,0), vec3(1,0,1));
				this.normals.push(vec3(0,1,0), vec3(0,1,0), vec3(0,1,0) );
				this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
				this.indices.push(15,16,17);

				this.vertices.push(vec3(0,1,0), vec3(1,0,0), vec3(1,0,1));
				this.normals.push(vec3(a,a,0), vec3(a,a,0), vec3(a,a,0) );
				this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
				this.indices.push(18,19,20);

				this.vertices.push(vec3(0,1,0), vec3(0,1,1), vec3(1,0,1));
				this.normals.push(vec3(a,a,0), vec3(a,a,0), vec3(a,a,0) );
				this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
			...
			inherit(flakeAce, shape);
				flakeAce.prototype.populate = function()
				{
					var a = 1/Math.sqrt(2);

					this.vertices.push(vec3(-.5,1,0), vec3(.5,1,0), vec3(.5,0,0));
					this.normals.push(vec3(0,0,1), vec3(0,0,1), vec3(0,0,1) );
					this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
					this.indices.push(0,1,2);

					this.vertices.push(vec3(-.5,1,0), vec3(-.5,0,0), vec3(.5,0,0));
					this.normals.push(vec3(0,0,1), vec3(0,0,1), vec3(0,0,1) );
					this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
					this.indices.push(3,4,5);

					this.vertices.push(vec3(.5,1,0), vec3(.5,0,0), vec3(.5,0,1));
					this.normals.push(vec3(1,0,0), vec3(1,0,0), vec3(1,0,0) );
					this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
					this.indices.push(6,7,8);
					...
					this.vertices.push(vec3(-.5,1,0), vec3(.5,1,0), vec3(-.5,0,1));
					this.normals.push(vec3(0,a,a), vec3(0,a,a), vec3(0,a,a) );
					this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
					this.indices.push(12,13,14);

					this.vertices.push(vec3(-.5,0,0), vec3(.5,0,0), vec3(-.5,0,1));
					this.normals.push(vec3(0,1,0), vec3(0,1,0), vec3(0,1,0) );
					this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
					this.indices.push(15,16,17);

					this.vertices.push(vec3(.5,0,0), vec3(.5,0,1), vec3(-.5,0,1));
					this.normals.push(vec3(0,1,0), vec3(0,1,0), vec3(0,1,0) );
					this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
					this.indices.push(18,19,20);

					this.vertices.push(vec3(.5,1,0), vec3(.5,0,1), vec3(-.5,0,1));
					this.normals.push(vec3(0,a,a), vec3(0,a,a), vec3(0,a,a) );
					this.texture_coords.push (vec2(0,0), vec2(0,1), vec2(1,0),vec2(1,1));
					this.indices.push(21,22,23);
